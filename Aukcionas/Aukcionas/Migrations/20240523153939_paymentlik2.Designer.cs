...
namespace Aukcionas.Migrations
{
    ...
    [Migration("20240523153939_paymentlik2")]
    partial class paymentlik2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aukcionas.Models.PaymentLinks", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("Payment_Link")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Aukcionas.Models.PaymentLinks", b =>
                {
                    b.HasOne("Aukcionas.Auth.Model.ForumRestUser", "User")
                        .WithMany("Payment_Links")

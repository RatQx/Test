...
namespace Aukcionas.Migrations
{
    ...
    [Migration("20240420100142_ChatFunctionv4")]
    partial class ChatFunctionv4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aukcionas.Models.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ReciverUserUserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Aukcionas.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Aukcionas.Models.Recommendations", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Aukcionas.Models.UserRecommendations", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("RecommendedAuctionIds")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Aukcionas.Models.Chat", b =>
                {
                    b.HasOne("Aukcionas.Auth.Model.ForumRestUser", "CreatedByUser")
                        .WithMany()
                        .HasForeignKey("CreatedByUserId");

                    b.HasOne("Aukcionas.Auth.Model.ForumRestUser", "ReciverUserUser")
                        .WithMany()
                        .HasForeignKey("ReciverUserUserId");

                    b.Navigation("CreatedByUser");

                    b.Navigation("ReciverUserUser");
                });
            ...
            modelBuilder.Entity("Aukcionas.Models.Message", b =>
                {
                    b.HasOne("Aukcionas.Auth.Model.ForumRestUser", "Sender")
                        .WithMany()
